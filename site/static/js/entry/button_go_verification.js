document.getElementById("button_go_verification").onclick = function() {
	...
	if (birth_y && birth_m && birth_d) t_birth_ymd.innerHTML = birth_y + "/" + birth_m + "/" + birth_d;
  ...
  if (school_graduate_y && school_graduate_m) t_school_graduate_ym.innerHTML = school_graduate_y + "/" + school_graduate_m;
